...
\begin{figure}
  ...
  \end{subfigure}
  \caption{A hard-to-scan sample from the significant scratches, with and without silicon carbide smeared on the surface of the core.}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Example of a single DPI measurement using a 1 mm stage micrometer with 0.01 mm graduations. We found the DPI measured at multiple locations in the field of view vertically and horizontally converged on the same value. The centerpoint of graduation marks used when taking this measurement.}
