...
\R{particle_smearing_1}Sanding samples in bulk inherently led to a few outlier samples having blemishes or imperfections on the scanning surface, thus we developed a bench-top method to circumvent the need to resand these samples. %  for logistical convenience. 
...
Particle smearing does not need to be done to every sample and is best reserved for samples that have proven to be difficult to stitch. We found this method did not interfere with the measurements of annual growth rings. Measurement of other anatomical measurements such as vessel counting will likely be affected.\R{particle_smearing_2}
