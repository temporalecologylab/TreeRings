...
% TODO: Measure point to point in pixels, convert with DPI, and point to point with physical measurement and compare accuracy. 
% I didn't write down the unique id's of each of the scans... only the species. I really do not want to scan a bunch more. 
% Can we do this only for the caliper first and then scans? Just say in the letter that we will need to scan new cores and would rather not. 
