...
is within the Z-value range across the entire surface area, a PID control algorithm takes the wheel. The information previously calculated in the image stack is sufficient 
