...
\item Introduction
	...
	\item Getting these data means measuring tree rings -- quick history
		...
		\begin{enumerate}
			\item vessel counting requires detail at the sub-vessel level % detail is only as good as sample prep
		\end{enumerate}
...
\item Materials and Methods
		...
		\begin{enumerate}
			\item Inconsistencies in cookie preparation, (different height, non parallel faces) (figure related) %inconsistent_cookies.jpg
